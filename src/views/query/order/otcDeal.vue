<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select class="filter-item" v-model="query.coinId" placeholder="请选择数字币" @change="handleFilter" clearable>
    ...
    <el-table :data="list" v-loading="listLoading" border fit highlight-current-row
      ...
      <el-table-column align="center" label="邮件" width="200" prop="email"></el-table-column>
      <el-table-column align="center" label="电话" width="150" prop="mobileNumber"></el-table-column>
      <el-table-column align="center" label="商户" width="100" prop="merchantName"></el-table-column>
      <el-table-column align="center" label="付款码" width="100" prop="payCode"></el-table-column>
      <el-table-column align="center" label="买卖方向" width="80">
        <template slot-scope="scope">
          <span>{{scope.row.type | typeFilter}}</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="币种" width="60" prop="coinCode"></el-table-column>
      <el-table-column align="center" label="数量" width="80" prop="quantity"></el-table-column>
      <el-table-column align="center" label="法币币种" width="100" prop="legalTenderCode"></el-table-column>
      <el-table-column align="center" label="价格" width="70" prop="price"></el-table-column>
      <el-table-column align="center" label="总金额" width="100" prop="totalAmount"></el-table-column>
      <el-table-column align="center" label="订单取消日期" width="160">
        <template slot-scope="scope">

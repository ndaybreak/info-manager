<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading="listLoading" border fit highlight-current-row
      ...
      <el-table-column align="center" label="经纪人参数说明" width="250" prop="description"></el-table-column>
      <el-table-column align="center" label="分佣比例" width="120" prop="brokerage_per"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form :rules="rules" :inline="true" ref="dataForm" :model="tempInfo" label-position="left" label-width="170px" style='width: 900px; margin-left:50px;'>
        <el-form-item label="分佣比例" prop="brokerage_per">
          <el-input-number v-model="tempInfo.brokerage_per" :precision="6" :step="0.01"></el-input-number>
        </el-form-item>
        <el-form-item label="经纪人参数说明" prop="description">
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          brokerage_per: [{ required: true, message: '请填写', trigger: 'blur' }],

<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading="listLoading" border fit highlight-current-row
      ...
      <el-table-column align="center" label="序号" width="100" prop="sortNum"></el-table-column>
      ...
      <el-table-column align="center" label="图片链接" width="200" prop="link"></el-table-column>
      <el-table-column align="center" label="备注" width="300" prop="info"></el-table-column>
      <el-table-column align="center" label="修改人" width="150" prop="name"></el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" class="slim-dialog">
      <el-form :rules="rules" ref="dataForm" :model="tempInfo" label-position="left" label-width="170px" style='width: 900px; margin-left:50px;'>
        ...
        <el-form-item label="图片" style="width: 600px;">
          <el-upload
          ...
          <span style="color: red;">图片尺寸：750*322pix</span>
        </el-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          info: [{ required: false, message: '请选择', trigger: 'blur' }],
          link: [{ required: false, message: '请选择', trigger: 'blur' }],
          sortNum: [{ required: true, message: '请填写', trigger: 'blur' }]
        },
        updatingObj: '',
        tradeList: [{
          id: true,

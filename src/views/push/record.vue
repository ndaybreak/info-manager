<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading="listLoading" border fit highlight-current-row
      ...
      <el-table-column align="center" label="电话" width="250" prop="mobile_number"></el-table-column>
      <el-table-column align="center" :label="$t('table.actions')" width="230" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" style="width: auto;" @click="handleAction(scope.row, 'sm')">查看短信记录</el-button>
          <el-button size="mini" type="warning" style="width: auto;" @click="handleAction(scope.row, 'email')">查看邮件记录</el-button>
        </template>
      </el-table-column>
    </el-table>

<template>
  <div class="app-container">
    ...
    <el-table :data="list" v-loading="listLoading" border fit highlight-current-row
      ...
      <el-table-column align="center" label="模板名称" width="150" prop="name"></el-table-column>
      ...
      <el-table-column align="center" :label="$t('table.actions')" width="310" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="mini" @click="handleDetail(scope.row, false)">详情</el-button>
          <el-button type="primary" size="mini" @click="handleUpdate(scope.row)">{{$t('table.edit')}}</el-button>
          <el-button size="mini" type="danger" @click="handleDelete(scope.row)">{{$t('table.delete')}}</el-button>
          <el-button size="mini" type="info" @click="handleCopy(scope.row)">复制</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      <el-button v-if="dialogStatus=='update'" @click="handleDetail(tempInfo, true)" style="margin-left: 50px;">编辑详情</el-button>
